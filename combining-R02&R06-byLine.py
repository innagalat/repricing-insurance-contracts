...
# 						percCalc(row['A_PREM_R02'], row['A_PREM_R06']), axis=1)
df
# ['$Diff_Total_Prem(R02vsR06)'] = df.apply(lambda row:
...
if ind_run_no == 2:
	...
	if policy_subset == 'ordinary-cover':
		cols = ['L_LIFE_ID', 'POL_NUMBER',
			...
			'SA', 'SA_IP'
			'A_PREM_R02', 'A_PREM_13_R02', 'BEL_R02',
...
if ind_run_no == 1:
	df = df.rename(columns= {
						...
						'%Ch_Total_Prem_13(R02vsR06)':'%Inc_AP13_to_AP25',
						'$Diff_Total_Prem_13(R02vsR06)':'$Inc_AP13_to_AP25',
						...
						'%Ch_Tot_Prem(R02)_toPrem13(R02)':'%Inc_AP1_to_AP13',
						'$Diff_Tot_Prem(R02)_toPrem13(R02)':'$Inc_AP1_to_AP13',
